...
19. [ ] Clean out the comments in `[[PackageName]].nuspec`.
20. [ ] Inform of default install location in description in `[[PackageName]].nuspec`.
...
27. [ ] Add icon key to `[[PackageName]].nuspec`.
